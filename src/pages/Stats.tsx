  ...
  return (
    <PageLayout>
      <div className="space-y-8">
        {/* Header Principal */}
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-xl p-8 text-white shadow-2xl">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Badge className={`${getRangColor(userStats.rang)} text-white text-lg px-6 py-3 rounded-full font-semibold shadow-lg`}>
        ...
        <Tabs defaultValue="stats" className="space-y-8">
          <TabsList className="grid w-full grid-cols-4 bg-white p-1 rounded-lg shadow-lg border-2 border-slate-200">
            <TabsTrigger value="stats" className="data-[state=active]:bg-slate-800 data-[state=active]:text-white data-[state=active]:shadow-md font-semibold text-black">
              <BarChart3 className="w-4 h-4 mr-2" />
              Stats Globales
            </TabsTrigger>
            <TabsTrigger value="records" className="data-[state=active]:bg-slate-800 data-[state=active]:text-white data-[state=active]:shadow-md font-semibold text-black">
              <Trophy className="w-4 h-4 mr-2" />
              Mes Records
            </TabsTrigger>
            <TabsTrigger value="historique" className="data-[state=active]:bg-slate-800 data-[state=active]:text-white data-[state=active]:shadow-md font-semibold text-black">
              <TrendingUp className="w-4 h-4 mr-2" />
              Historique
            </TabsTrigger>
            <TabsTrigger value="objectifs" className="data-[state=active]:bg-slate-800 data-[state=active]:text-white data-[state=active]:shadow-md font-semibold text-black">
          ...
          <TabsContent value="stats" className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {Object.entries(userStats.stats).map(([stat, valeur]) => (
                <Card key={stat} className={`${getStatBgColor(stat)} border-2 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1`}>
                  <CardContent className="p-6 text-center">
                    <div className={`${getStatColor(stat)} mb-4 flex justify-center`}>
                      {getStatIcon(stat)}
                    </div>
                    <h3 className="text-xl font-bold capitalize mb-3 text-black">
                      {stat === 'poidsCorps' ? 'Poids du Corps' : stat}
                    </h3>
                    <div className="text-4xl font-bold mb-4 text-black">{valeur}/100</div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {Object.entries(userStats.stats).map(([stat, valeur]) => (
                    <div key={stat} className="text-center space-y-3">
                      <div className={`w-20 h-20 mx-auto rounded-full ${getStatColor(stat)} bg-opacity-20 flex items-center justify-center shadow-lg`}>
                        {getStatIcon(stat)}
                      </div>
                      <div className="space-y-1">
                        ...
                        <div className="text-2xl font-bold text-black">{valeur}</div>
          ...
          <TabsContent value="records" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Force */}
              <Card className="border-2 border-red-300 bg-gradient-to-br from-red-50 to-red-100 shadow-lg">
                <CardHeader className="pb-4">
                ...
                <CardContent className="space-y-4">
                  {Object.entries(userStats.records.force).map(([exercice, data]) => (
                    <div key={exercice} className="flex justify-between items-center p-4 bg-white rounded-lg border-2 border-red-200 hover:shadow-md transition-all duration-200">
                      <div className="space-y-1">
              ...
              {/* Endurance */}
              <Card className="border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-blue-100 shadow-lg">
                <CardHeader className="pb-4">
                ...
                <CardContent className="space-y-4">
                  {Object.entries(userStats.records.endurance).map(([distance, data]) => (
                    <div key={distance} className="flex justify-between items-center p-4 bg-white rounded-lg border-2 border-blue-200 hover:shadow-md transition-all duration-200">
                      <div className="space-y-1">
              ...
              {/* Vitesse */}
              <Card className="border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-amber-100 shadow-lg">
                <CardHeader className="pb-4">
                ...
                <CardContent>
                  <div className="flex justify-between items-center p-4 bg-white rounded-lg border-2 border-amber-200 hover:shadow-md transition-all duration-200">
                    <div className="space-y-1">
              ...
              <Card className="border-2 border-green-300 bg-gradient-to-br from-green-50 to-green-100 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  {Object.entries(userStats.records.poidsCorps).map(([exercice, data]) => (
                    <div key={exercice} className="flex justify-between items-center p-4 bg-white rounded-lg border-2 border-green-200 hover:shadow-md transition-all duration-200">
                      <div className="space-y-1">
                        <div className="font-bold text-lg capitalize text-black">{exercice}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {userStats.historique.map((entry, index) => (
                    <div key={entry.date} className="flex items-center justify-between p-6 bg-white border-2 border-slate-200 rounded-xl hover:shadow-lg transition-all duration-200">
                      <div className="flex items-center gap-6">
                        <div className="text-lg font-bold text-black bg-slate-100 px-4 py-2 rounded-lg">
                          {entry.date}
                        </div>
          ...
          <TabsContent value="objectifs" className="space-y-6">
            <Card className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-300 shadow-xl">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl font-bold text-black flex items-center gap-3">
              ...
              <CardContent className="space-y-8">
                <div className="text-center p-8 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl border-2 border-purple-200">
                  ...
                  <Badge className="bg-gradient-to-r from-purple-500 to-blue-500 text-white text-lg px-6 py-3 rounded-full font-semibold shadow-lg">
                ...
                <div className="text-center">
                  <Button size="lg" className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-semibold">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="text-center p-6 bg-white border-2 border-slate-200 hover:shadow-lg transition-all duration-200">
